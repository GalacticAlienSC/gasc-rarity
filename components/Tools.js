...
export const Tools = (props) => {
  ...
  return (
    <div onChange={handleChange} className="px-2 mt-4">
      <h3 className="text-xs text-[#202520] uppercase mb-2 font-bold">
        Sort By
      </h3>
      {!(sort_by == "rarity_score" && order == "desc") && (
        <a
          className="hover:bg-[#d0e8f5] hover:text-[#202520]  cursor-pointer text-xs text-[#202520] py-2 px-2 rounded-md w-full flex items-center"
          onClick={() => {
      ...
      {!(sort_by == "rarity_score" && order == "asc") && (
        <a
          className="hover:bg-[#d0e8f5] hover:text-[#202520] cursor-pointer text-[#202520] py-2 px-2 rounded-md w-full flex items-center"
          onClick={() => {
